...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.html" class="logo">
            ...
            <span class="logo-mini"><b>乐购商城</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>乐购商城-运营商后台</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${user.headimgurl}" class="user-image" alt="User Image">
                            <span class="hidden-xs">${ user.nickname }</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="${user.headimgurl}" class="img-circle" alt="User Image">
    ...
    <footer class="main-footer">
        ...
        <strong><a href="https://tuoxin.ke.qq.com">腾讯课堂拓薪教育</a></strong>
    </footer>
    <!-- 底部导航 /-->
