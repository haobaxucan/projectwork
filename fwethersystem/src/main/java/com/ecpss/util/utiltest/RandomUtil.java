...
public class RandomUtil extends Random {
     ...
     * @return 随机字符串
     */
    public static String allString(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
    ...
    /**
     * 定长的随机纯字母字符串(包含大 小写字母)
     *
     * @param length 随机字符串长度
     * @return 随机字符串
     */
    public static String partString(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
    ...
    public static void main(String[] args) {
        Random random=new Random();
        System.out.println("50范围的随机数"+ random.nextInt(50));
        System.out.println(RandomUtil.allString(10));
        System.out.println(RandomUtil.lowerString(4));
    ...
    public static String lowerString(int length) {
        return allString(length).toLowerCase();
    }
    ...
    public static String upperString(int length) {
        return allString(length).toUpperCase();
    }
